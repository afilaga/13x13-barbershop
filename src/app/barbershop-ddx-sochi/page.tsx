...
export const metadata: Metadata = {
    ...
    description: "Ищете барбершоп рядом с DDX в Сочи? 13x13 находится прямо напротив входа в DDX Fitness на Горького 81а. Стрижки от 400 ₽ для тех, кто ценит дисциплину и время. Официальное открытие 13 апреля!",
    keywords: [
