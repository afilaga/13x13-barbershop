...
export const metadata: Metadata = {
    ...
    description: "Ищете барбершоп рядом с DDX в Сочи? 13x13 находится на Горького 81а. Честная цена, понятный сервис и мужские стрижки без переплаты за лишнее.",
    keywords: [
    ...
    openGraph: {
        ...
        description: "13x13 — барбершоп в Сочи с честной ценой, понятным сервисом и мужскими стрижками без переплаты за лишнее. Горького 81а.",
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            },
                            {
                                ...
                                a: "У нас честная и понятная цена без переплаты за лишнее. Актуальный прайс можно посмотреть на сайте или уточнить при записи."
                            }
                        ].map((faq, idx) => (
