...
export const metadata: Metadata = {
  ...
  description: "Лоукост барбершоп 13x13 в Сочи. Стрижём и бреем от 400 рублей! Честные цены. Получи скидку на первую стрижку! Находимся на Горького 81а, напротив клуба DDX.",
  verification: {
  ...
  openGraph: {
    ...
    url: SITE_URL,
    title: "13x13 | Лоукост барбершоп в Сочи",
    description: "Лоукост барбершоп 13x13 в Сочи. Стрижём и бреем от 400 рублей! Получи скидку на первую стрижку!",
    siteName: "13x13",
    images: [
      {
        url: "/og-image.png",
